...
function bumblebee_enqueue_create_assets(){
  ...
  $loc_js_ver     = bumblebee_asset_version('assets/create.locations.js');
  ...
  wp_register_script('bumblebee-create-locations', BUMBLEBEE_URL.'assets/create.locations.js', ['jquery','media-editor'], $loc_js_ver, true);
  wp_register_script('bumblebee-create-form', BUMBLEBEE_URL.'assets/create.form.js', ['jquery','bumblebee-create-locations','bumblebee-create-pickers'], $form_js_ver, true);
